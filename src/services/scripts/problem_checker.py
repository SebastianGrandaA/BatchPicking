...
from .openInstances import openAdjacencyMatrix, openConstraints, openSupportList
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Problem Checker and evaluator for POIP 2024. Problem folder is mandatory."
    )
    ...
    check_options.add_argument(
        ...
        "--fail_fast_check",
        action="store_true",
        help="Stop program at first problem-checking error found",
    )
    check_options.add_argument(
        "-flc",
        "--fail_last_check",
        action="store_true",
        help="Stop program after all problem-checking errors are found -> DEFAULT",
    )
