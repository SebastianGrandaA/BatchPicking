...
from logging import INFO, DEBUG, WARNING, basicConfig, getLogger
...
if __name__ == "__main__":
    ...
    Optimize use case:
        ...
        python src -u optimize -m joint -n warehouse_D/data_2023-01-30_12
    ...
    parser.add_argument('-m', '--method', type=str, help='Method to use', required=True, choices=['sequential', 'joint'])
    parser.add_argument('-n', '--instance_name', type=str, help='Instance name', required=False)
    parser.add_argument('-ns', '--instance_names', type=str, help='Instance names', required=False)
    parser.add_argument('-t', '--timeout', type=int, help='Timeout', required=False, default=DEFAULT_TIMEOUT)
    parser.add_argument('-l', '--log_level', type=str, help='Log level', required=False, default='DEBUG', choices=['DEBUG', 'INFO'])
